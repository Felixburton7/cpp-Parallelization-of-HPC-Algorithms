...
A C++17 / MPI molecular-dynamics solver written for Scientific Computing Lab at the University of Cambridge to analyze current processes. Velocity-Verlet integration for a 1D anharmonic oscillator and a 3D Lennard-Jones fluid, with a domain-decomposed parallel force computation.
