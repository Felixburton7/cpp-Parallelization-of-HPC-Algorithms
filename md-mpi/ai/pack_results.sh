...
# Package ordering (project-wide, not only Results 2)
{
    ...
    echo "4. out/plots/results2_lj_brief_energy_100step_production.png"
    echo "5. out/plots/results2_lj_brief_temperature_100step_production.png"
    echo "6. out/plots/results2_lj_rdf_comparison_rahman1964.png"
    echo "7. out/scaling_strong.csv"
    echo "8. out/scaling_size.csv"
    echo ""
} >> "$TMP_BODY"
